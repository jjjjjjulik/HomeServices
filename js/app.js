(() => {
            ...
            function setSpollerAction(e) {
                ...
                if (el.closest("[data-spoller]")) {
                    ...
                    if (!spollersBlock.querySelectorAll("._slide").length) {
                        ...
                        const spollersItem = spollerTitle.closest(".spollers-questions__item");
                        if (spollersItem) spollersItem.classList.toggle("spoller-open");
                    }
                    e.preventDefault();
                }
            }
    ...
    function initSliders() {
        if (document.querySelector(".body-review__slider")) new swiper_core_Swiper(".body-review__slider", {
            ...
            navigation: {
                prevEl: ".body-review__button--left",
                nextEl: ".body-review__button--rigth"
            },
            on: {}
        });
    }
